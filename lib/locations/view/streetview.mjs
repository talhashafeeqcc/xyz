export default _xyz => entry => {
  ...
  if(entry.__label_div) entry.__label_div.style.gridColumn = "1 / span 2";
  ...
  entry.listview.appendChild(_xyz.utils.wire()`
    <div class="${entry.class || ''}" style="grid-column: 1 / span 2;">
    <a target="_blank" href="${'https://www.google.com/maps?cbll=' + lnglat[1] + ',' + lnglat[0] + '&layer=c'}">
    <img src="${src}">
  `);
