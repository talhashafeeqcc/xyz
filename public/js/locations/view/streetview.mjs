export default _xyz => entry => {
  ...
  const src = `${_xyz.host}/api/proxy/request?uri=https://maps.googleapis.com/maps/api/streetview?location=${lnglat[1]},${lnglat[0]}&source=outdoor&size=300x230&provider=GOOGLE&token=${_xyz.token || ''}`;
